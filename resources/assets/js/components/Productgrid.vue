...
<li class="item col-lg-3 col-md-4 col-sm-6 col-xs-6 ">
    ...
    <div class="item-inner">
        ...
        <figure v-if="product.images.length"> <a v-for="(image, index) in product.images.slice(0,2)" :key="image.index" :class="{ 'hover-img': index===1}" href="single_product.html"><img :data-src="image.path" alt=""></a></figure>
        <figure v-else> <a href="single_product.html"><img data-src="https://lorempixel.com/200/200/?44316" alt=""></a></figure>
        </div>
