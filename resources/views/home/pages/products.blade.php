...
@section('page')
<!-- Breadcrumbs -->
    @component('home.components.breadcrumbs')
        @slot('label')
            Man
        @endslot
        @slot('category')
    ...
    <div class="container">
        ...
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
            <div class="category-description std">
                @include('home.components.productSlider')
            </div>
            
            @include('home.components.productGrid')
        ...
        <aside class="sidebar col-sm-3 col-xs-12 col-sm-pull-9">
            ...
            <div class="block-content">
                ...
                <ul>
                <li class="item"> <a href="shopping_cart.html" title="Sample Product" class="product-image"><img src="images/products/img01.jpg" alt="Sample Product "></a>
                ...
                <li class="item last"> <a href="#" title="Sample Product" class="product-image"><img src="images/products/img01.jpg" alt="Sample Product"></a>
                    <div class="product-details">
                    <div class="access"> <a href="#" title="Remove This Item" class="remove-cart"><i class="icon-close"></i></a></div>
